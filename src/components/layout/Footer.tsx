...
const defaultSections: FooterSection[] = [
  {
    ...
    links: [
      ...
      { label: 'Download', href: 'https://app.liftfire.app', external: true },
    ],
  },
  {
    title: 'Community',
    links: [
      ...
      { label: 'Beta Program', href: '/community#beta' },
    ],
  },
  {
    title: 'Support',
  ...
  },
  {
    ...
    links: [
      ...
      {
        label: 'Open Source',
        href: 'https://github.com/liftfire/liftfire/blob/main/LICENSE',
        external: true,
      },
    ],
  },
